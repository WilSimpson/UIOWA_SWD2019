...
/**
 * Simulates taking in a variety of requests and prints diagnostic information about each request.
 *
 * @author swd
 */
public class Server
{
    ...
    /**
     * Start of the program. Does not require or check for runtime arguments
     *
