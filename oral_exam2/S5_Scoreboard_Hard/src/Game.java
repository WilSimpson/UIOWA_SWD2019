 ...
 * current period of size larger than the total number of periods represents that the game has ended. A game is not
 * started until the startGame() method is called and the number of periods has been initialized to 1.
 *
 * @author Wil Simpson
 */
